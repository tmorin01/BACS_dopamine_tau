---
title: "Fig s5 - Tau Burden vs. Memory/Learning"
author: "Tom Morin"
date: "2024-07-31"
...
# Read in data
data_AC <- read_csv('data_sup_fig05ac.csv')
data_BD <- read_csv('data_sup_fig05bd.csv')
```
...
ggsave(behavioral_fig, filename = 'sup_fig05.pdf', width = 6.5, height = 6, units = 'in')
