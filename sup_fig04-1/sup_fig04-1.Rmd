---
title: "Fig S4-1 - Valence Effect and Tau Burden"
author: "Tom Morin"
date: "2025-12-16"
...
df <- read_csv('data_sup_fig04-1.csv')
...
## Plot Panel A: Valence Index vs. Tau Burden
```{r, echo = FALSE}
figA <- df %>% 
...
## Plot Panel B: FMT vs. Valence Index, by Tau Burden
```{r, echo = FALSE}
...
ggsave(pos_fig, filename = 'sup_fig04-1.pdf', width = 6, height = 3, units = 'in')
pos_fig
```