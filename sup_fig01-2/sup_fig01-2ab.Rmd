---
title: "Fig. 1-2ab - Performance During Task Learning Phase"
author: "Tom Morin"
date: "2025-12-16"
...
# Read in data
df <- read_csv('data_sup_fig01-2ab.csv')
...
## Plot full Figure s1-2ab
```{r, echo = FALSE}
behavioral_fig <- ggarrange(figA, figB,
          ncol = 2,
          labels = c('A', 'B'))

ggsave(behavioral_fig, filename = 'sup_fig01-2ab.pdf', width = 6.5, height = 2.5, units = 'in')
